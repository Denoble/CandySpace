...
final class GalleryViewModelTests: XCTestCase {
    var viewModel: GalleryViewModel?
     ...
     func testGetImageGallerySuccess() async throws {
         ...
         viewModel = GalleryViewModel(networkManager: mockNetworkManager, imageCache: ImageCache(), searchResultCache: SearchResultCache())
         ...
         XCTAssertEqual(viewModel?.searchResultCache.getResults(searchTerm: "nature")?.count, expectedImageCount, "Cache did not get set")
     }
